...
function Home() {
  useEffect(() => {
    ...
    const changeTheme = () => {
      const nextIsDarkTheme = !document.body.classList.contains("dark-theme");
      const nextTheme = nextIsDarkTheme ? "dark" : "light";
      document.body.classList.toggle("dark-theme", nextIsDarkTheme);
      localStorage.setItem("theme", nextTheme);
      themeSwitch.setAttribute("aria-pressed", String(nextIsDarkTheme));
    };
    ...
    return () => {
      themeSwitch.removeEventListener("click", changeTheme);
  ...
  return (
    <div>
      ...
      <section>
        <div class="nav-bar">
          <div class="nav-box">
            ...
            <div class="nav-btn">
              <div class="nav-btn1">Try it Free</div>
            </div>
          </div>
        </div>
      </section>
      <div class="ham1">
        <div class="ham2">
          <div class="logo-txt1">DARSIN</div>
        ...
        <div class="third-page1">
          <div class="third-box1">
            <div class="third-txt1">
              A digital web design studio creating <br></br>modern & engaging
              online <br></br>experiences
            </div>
            <div class="third-para1">
              Separated they live in Bookmarksgrove right at the coast of the{" "}
              <br></br>Semantics, a large language ocean. A small river named
              Duden<br></br> flows by their place and supplies it with the
      ...
      <div class="fourth-page">
        ...
        <div class="fourth-page1">
          <div class="fourth-tit1">Build your dream website today</div>
          <p class="fourth-para">
            But nothing the copy said could convince her and so it didn’t take
            long until a few <br></br>insidious Copy Writers ambushed her.
          </p>
        ...
        <div class="fiveth-pag2">
          <div class="fifth-box1">
            ...
            <p class="fifth-para">
              ...
              business website. Make your bids stand-out<br></br> with amazing
              options.
            </p>
          </div>
      ...
      <div class="seventh-page">
        <div class="seventh-page1">
          <div class="seventh-box1">
            ...
            <p class="seventh-para">
              In an ideal world this website wouldn’t exist, a client would
              acknowledge the importance of having web<br></br> copy before the
              Proin vitae ipsum vel ex finibus semper design starts.
            </p>
          </div>
        ...
        <div class="eighth-page1">
          <div class="eighth-box1">
            ...
            <p class="eighth-para">
              ...
              thousands of bad Commas, wild Question Marks and devious pulvinar
          ...
          <div class="eighth-box2">
            <div class="eighth-con1">
              <div class="eighth-cn1">
                ...
                <div class="eighth-text2">
                  Ruben Reed -<b class="eighth-na1"> Charleston</b>
                </div>
              </div>
            </div>
            <div class="eighth-con2">
              <div class="eighth-cn2">
                ...
                <div class="eighth-text3">
                  Michael P. Howlett -<b class="eighth-na2"> Worcester</b>
                </div>
              </div>
            </div>
            <div class="eighth-con3">
              <div class="eighth-cn3">
                <img
                  class="eighth-img3"
                  src={IMAGES.EIGHTHIMGTHREE}
                  alt=""
                ></img>
                <div class="eighth-cb3">
                  <div class="eighth-pa-3">
                ...
                <div class="eighth-text4">
                  Theresa D. Sinclair -<b class="eighth-na3"> Lynchburg</b>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="ninth-page">
        <img
          ...
          height="400px"
          class="ninth-img"
          src={IMAGES.NINTHIMGONE}
          alt=""
        ></img>
        <div class="ninth-bg"></div>
        <div class="ninth-page1">
          <div class="ninth-tit1">Let's Get Started</div>
        ...
        <div class="tenth-page1">
          ...
          <div class="tenth-box2">
            ...
            <div class="tenth-con3">
              ...
              <div class="tenth-cn3">
                <div class="tenth-tit3">Travelling</div>
                <div class="tenth-pa3">Why are so many people..</div>
                <div class="tenth-para4">
                  Far far away, behind the word mountains, far from the
                  countries Vokalia and Consonantia.
                </div>
                <div class="tenth-btn3">
                  Read More <FontAwesomeIcon icon={faArrowRight} />
                </div>
              </div>
            </div>
      ...
      <div id="Contact" class="eleventh-page">
        <div class="eleventh-page1">
          <div class="eleventh-box1">
            ...
            <p class="eleventh-para">
              We thrive when coming up with innovative ideas but also understand
              that a smart concept should be<br></br> supported with faucibus
          ...
          <div class="eleventh-box2">
            ...
            <div class="eleth-con2">
              ...
              <div class="eleth-btn">
                <div class="eleth-btn1">Send Message</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="thirteen-page1">
          <div class="thirteen-box1">
            <div class="thirteen-con1">
              <div class="thirteen-tit1">DARSIN</div>
            ...
            <div class="thirteen-con2">
              <div class="thirteen-tit2">Information</div>
            ...
            <div class="thirteen-con3">
              <div class="thirteen-tit3">Support</div>
            ...
            <div class="thirteen-con4">
              <div class="thirteen-tit4">Subscribe</div>
              ...
              <div class="thirteen-nc2">
                <input
                  id="email"
                  class="thirteen-email"
                  type="email"
                  placeholder="Email"
                ></input>
                <a class="thirteen-font1" href="email">
      ...
      <div class="fourteen-page">
        <div class="fourteen-page1">
          <div class="fourteen-box1">
            <div class="fourteen-txt1">2024 © Darsin - Themesbrand</div>
      ...
      <div class="container">
        <div class="container1">
          <button type="button" class="sun1" id="theme-switch" aria-label="Toggle light and dark theme" aria-pressed="false">
